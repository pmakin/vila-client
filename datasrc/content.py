...
anim = Animation("inair_left")
anim.back_foot.frames.Add(AnimKeyframe(0.0, -3, 0, -0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.2, -5, 0, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.4, -8, 0, -0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.6, -8, 0, -0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.8, -5, 0, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(1.0, -3, 0, -0.2))

anim.front_foot.frames.Add(AnimKeyframe(0.0, 3, 0, -0.2))
anim.front_foot.frames.Add(AnimKeyframe(0.2, 5, 0, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.4, 8, 0, -0.2))
anim.front_foot.frames.Add(AnimKeyframe(0.6, 8, 0, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.8, 5, 0, -0.2))
anim.front_foot.frames.Add(AnimKeyframe(1.0, 3, 0, -0.1))

container.animations.Add(anim)

anim = Animation("inair_right")
anim.back_foot.frames.Add(AnimKeyframe(0.0, 3, 0, 0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.2, 5, 0, 0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.4, 8, 0, 0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.6, 8, 0, 0.2))
...
anim.back_foot.frames.Add(AnimKeyframe(0.0,-10,-4, 0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.2, -8,-8, 0.3))
anim.back_foot.frames.Add(AnimKeyframe(0.4, 4,-4,-0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.6, 8, 0, 0))
anim.back_foot.frames.Add(AnimKeyframe(0.8, 8, 0, 0))
anim.back_foot.frames.Add(AnimKeyframe(1.0,-10,-4, 0.2))

anim.front_foot.frames.Add(AnimKeyframe(0.0, 8, 0, 0))
anim.front_foot.frames.Add(AnimKeyframe(0.2, -8, 0, 0))
anim.front_foot.frames.Add(AnimKeyframe(0.4,-10,-4, 0.2))
anim.front_foot.frames.Add(AnimKeyframe(0.6, -8,-8, 0.3))
anim.front_foot.frames.Add(AnimKeyframe(0.8, 4,-4,-0.2))
anim.front_foot.frames.Add(AnimKeyframe(1.0, 8, 0, 0))

container.animations.Add(anim)

anim = Animation("skid_left")
anim.body.frames.Add(AnimKeyframe(0.0, 0, 0, 0))
anim.body.frames.Add(AnimKeyframe(0.2, 1,-1, 0))
anim.body.frames.Add(AnimKeyframe(0.4, 2,-2, 0))
anim.body.frames.Add(AnimKeyframe(0.6, 2,-2, 0))
anim.body.frames.Add(AnimKeyframe(0.8, 2,-2, 0))
anim.body.frames.Add(AnimKeyframe(1.0, 1,-1, 0))

anim.back_foot.frames.Add(AnimKeyframe(0.0, -8, 0, 0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.2, -7, 0, 0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.4, -6, 0, 0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.6, -7, 0, 0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.8, -8, 0, 0.2))
anim.back_foot.frames.Add(AnimKeyframe(1.0, -7, 0, 0.2))

anim.front_foot.frames.Add(AnimKeyframe(0.0, -6, 0, 0.2))
anim.front_foot.frames.Add(AnimKeyframe(0.2, -7, 0, 0.2))
anim.front_foot.frames.Add(AnimKeyframe(0.4, -8, 0, 0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.6, -7, 0, 0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.8, -6, 0, 0.2))
anim.front_foot.frames.Add(AnimKeyframe(1.0, -7, 0, 0.2))

container.animations.Add(anim)

anim = Animation("skid_right")
anim.body.frames.Add(AnimKeyframe(0.0, 0, 0, 0))
anim.body.frames.Add(AnimKeyframe(0.2, -1,-1, 0))
anim.body.frames.Add(AnimKeyframe(0.4, -2,-2, 0))
anim.body.frames.Add(AnimKeyframe(0.6, -2,-2, 0))
...
anim.back_foot.frames.Add(AnimKeyframe(0.0, 6, 0, -0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.2, 7, 0, -0.2))
anim.back_foot.frames.Add(AnimKeyframe(0.4, 8, 0, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.6, 7, 0, -0.1))
anim.back_foot.frames.Add(AnimKeyframe(0.8, 6, 0, -0.2))
anim.back_foot.frames.Add(AnimKeyframe(1.0, 7, 0, -0.2))

anim.front_foot.frames.Add(AnimKeyframe(0.0, 8, 0, -0.2))
anim.front_foot.frames.Add(AnimKeyframe(0.2, 7, 0, -0.2))
anim.front_foot.frames.Add(AnimKeyframe(0.4, 6, 0, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.6, 7, 0, -0.1))
anim.front_foot.frames.Add(AnimKeyframe(0.8, 8, 0, -0.2))
anim.front_foot.frames.Add(AnimKeyframe(1.0, 7, 0, -0.2))
container.animations.Add(anim)
